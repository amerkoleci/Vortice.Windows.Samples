...
namespace WinUI_Example
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        {
            DrawTextApp app = new(new WinUIAppPlatform(this, SwapChainPanel));
            app.Run();
        }


        class DrawTextApp : D3D11Application
        {
            ...
            private static IDWriteFactory _directWriteFactory;
            private static IDWriteTextFormat _textFormat;
            private static ID2D1Factory7 _direct2dFactory;
            private static ID2D1SolidColorBrush _brush;
            private static ID2D1RenderTarget _renderTarget2d;

            public DrawTextApp(AppPlatform platform)
                : base(platform)
            {
